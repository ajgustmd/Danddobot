...
model = this.default_val.model;
temperature = this.default_val.temperature;
max_tokens = this.default_val.max_tokens;
top_p = this.default_val.top_p;
frequency_penalty = this.default_val.frequency_penalty;
presence_penalty = this.default_val.presence_penalty;
